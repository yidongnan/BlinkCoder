...
//        , imagePath: URL + "jsp/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        , imagePath: "http://michaelchen.qiniudn.com/"
...
//        , imageManagerUrl: URL + "jsp/imageManager.jsp"       //图片在线管理的处理地址
        , imageManagerUrl: "/action/qiniu/imageManager"
//        , imageManagerPath: URL + "jsp/"                                    //图片修正地址，同imagePath
        , imageManagerPath: "http://michaelchen.qiniudn.com/"
        ...
        /*, toolbars:[
         ...
         'print', 'preview', 'searchreplace', 'help']
            ...
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'link', 'unlink', '|',
                'insertcode', 'insertimage', 'insertvideo', 'attachment', 'horizontal', '|',
                'preview']
        ]
